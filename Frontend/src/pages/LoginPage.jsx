...
export default function LoginPage({ onLogin, loading, demoUsers }) {
  ...
  const userGroups = {
    'ACME Corp': ['user_hr_1', 'user_hr_2'],
    'TechCorp': ['user_eng_1', 'user_eng_2'],
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-background to-purple-50 p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-3xl font-bold">OrgRAG</CardTitle>
          <CardDescription className="text-base">
            Multi-organization knowledge assistant
          </CardDescription>
        </CardHeader>
